    ...
    <main>
        ...
        <div class="post">
            ...
            <div class="slideshow-container">
                ...
                <img src="/assets/media/personal/2024/02February/Threadmill7.jpg" style="width:30%">
                <div class="text">Caption Text</div>
                </div>

                <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="/assets/media/personal/2024/02February/Threadmill6.jpg" style="width:30%">
                <div class="text">Caption Two</div>
                </div>

                <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="/assets/media/personal/2024/02February/Threadmill4.jpg" style="width:30%">
