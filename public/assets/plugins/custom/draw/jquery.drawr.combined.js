...
jQuery.fn.drawr.register({
	...
	drawStart: function(brush,context,x,y,size,alpha,event){
		...
		if(typeof brush.$floatyBox=="undefined"){
			...
			brush.$floatyBox.css({
				left: $(this).parent().offset().left + (x*self.zoomFactor) - this.scrollX - 350,
				top: $(this).parent().offset().top + (y*self.zoomFactor) - this.scrollY - 550,
			});
	...
	drawSpot: function(brush,context,x,y,size,alpha,event) {
		...
		if(typeof brush.$floatyBox=="undefined"){
			...
			brush.$floatyBox.css({
				left: $(this).parent().offset().left + (x*this.zoomFactor) - this.scrollX - 350,
				top: $(this).parent().offset().top + (y*this.zoomFactor) - this.scrollY - 550,
			});
		}
	}
});
