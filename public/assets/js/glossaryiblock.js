"use strict";
var KTSubscriptionsAdvanced_glossary = function () {
    var t, e, n = function () {
        t.querySelectorAll("tbody tr").forEach(((t, e) => {
            const n = t.querySelector("td:first-child input"),
                ...
                i = n.getAttribute("id"),
                r = o.getAttribute("id");
                n.setAttribute("name", "titleglossary" + "-" + e), o.setAttribute("name", "defglossary" + "-" + e);
                n.setAttribute('id', 'titleglossary-' + e), o.setAttribute('id', 'defglossary-' + e);
                n.setAttribute('onClick', 'suggestionsgloss(' + e + ');')
        }))
    };
    return {
        init: function () {
            t = document.getElementById("kt_create_new_custom_fields_glossary"),
                function () {
                    const o = document.getElementById("kt_create_new_custom_fields_add_glossary"),
...
KTUtil.onDOMContentLoaded((function () {
    KTSubscriptionsAdvanced_glossary.init();
