    ...
    var e, t, n, r, o = document.getElementById("kt_table_users"),
        c = () => {
            o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t => {
                t.addEventListener("click", (function (t) {
                    ...
                    Swal.fire({
                        text: "Are you sure you want to reactivate " + r + "?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        ...
                        t.value ? Swal.fire({
                            ...
                            text: customerName + " was not reactivated.",
                            icon: "error",
                            buttonsStyling: !1,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
        ...
        l = () => {
            ...
            c.forEach((e => {
                ...
                Swal.fire({
                    text: "Are you sure you want to reactivate selected customers?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    t.value ? Swal.fire({
                        text: "You have reactivated all selected customers!.",
                        icon: "success",
                        buttonsStyling: !1,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
                        ...
                        text: "Selected customers were not reactivated.",
                        icon: "error",
                        buttonsStyling: !1,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
