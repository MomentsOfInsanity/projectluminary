...
var KTUsersList1 = function () {
    var e, t, n, r, o = document.getElementById("kt_datatable_select"),
        c = () => {
    ...
    return {
        init: function () {
            ...
            })), (e = $("#kt_datatable_select").DataTable({
                info: !1,
                order: [],
                pageLength: 10,
                lengthChange: !1,
...
var KTUsersList2 = function () {
    var e, t, n, r, o = document.getElementById("kt_datatable_select2"),
        c = () => {
            o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t => {
                t.addEventListener("click", (function (t) {
                    var urlToRedirect = t.currentTarget.getAttribute('href');
    ...
    return {
        init: function () {
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                ...
                const l = moment(t[5].innerHTML, "DD MMM YYYY, LT").format();
                t[6].setAttribute("data-order", l)
            })), (e = $("#kt_datatable_select2").DataTable({
                info: !1,
                order: [],
                pageLength: 10,
                lengthChange: !1,
...
var KTUsersList3 = function () {
    var e, t, n, r, o = document.getElementById("kt_datatable_select3"),
        c = () => {
            o.querySelectorAll('[data-kt-users-table-filter="delete_row"]').forEach((t => {
                t.addEventListener("click", (function (t) {
                    var urlToRedirect = t.currentTarget.getAttribute('href');
    ...
    return {
        init: function () {
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                ...
                const l = moment(t[5].innerHTML, "DD MMM YYYY, LT").format();
                t[6].setAttribute("data-order", l)
            })), (e = $("#kt_datatable_select3").DataTable({
                info: !1,
                order: [],
                pageLength: 10,
                lengthChange: !1,
