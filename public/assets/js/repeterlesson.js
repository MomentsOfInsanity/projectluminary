"use strict";
var KTSubscriptionsAdvanced_lf = function () {
    var t, e, n = function () {
        t.querySelectorAll("tbody tr").forEach(((t, e) => {
            const n = t.querySelector("td:first-child input"),
                ...
                i = n.getAttribute("id"),
                r = o.getAttribute("id");
                n.setAttribute("name", "titlelesson" + "-" + e), o.setAttribute("name", "filelesson" + "-" + e);
                n.setAttribute('id', 'titlelesson-' + e), o.setAttribute('id', 'filelesson-' + e)
        }))
    };
    return {
        init: function () {
            t = document.getElementById("kt_create_new_custom_fields_lf"),
                function () {
                    const o = document.getElementById("kt_create_new_custom_fields_add_lf"),
...
KTUtil.onDOMContentLoaded((function () {
    KTSubscriptionsAdvanced_lf.init();
